...
import { faWhatsapp , faFacebook , faInstagram , faXTwitter , faTiktok } from '@fortawesome/free-brands-svg-icons'
    ...
    return (
        <footer className='footer'>
            <div className={styles.footerMain}>
                ...
                <section className={styles.footerFollow}>                
                    <h3>Follow Us</h3>
                    <ul>
            ...
            <div className={styles.footerPortfolio}>
